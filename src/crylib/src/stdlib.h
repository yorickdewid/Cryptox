 ...
 * Copyright (C) 2017-2018 Cryptox, Blub Corp.
 * All Rights Reserved
 *
...
#define __CRYLIB_INTERNAL_STARTING_HEADER_IMPLEMENTATION
...
#if __HAVE_FLOAT128 && __CRYLIB_USE (IEC_60559_TYPES_EXT)
...
#if __CRYLIB_USE (IEC_60559_BFP_EXT)
