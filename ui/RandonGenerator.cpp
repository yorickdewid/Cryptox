	...
	: wxDialog(parent, id, title, pos, size, style)
{
	...
	m_textCtrl6 = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(200, -1), wxTE_MULTILINE | wxTE_NO_VSCROLL);
	...
	m_textCtrl7 = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(-1, 100), wxTE_MULTILINE | wxTE_READONLY);
	...
	m_button12 = new wxButton(this, wxID_ANY, wxT("Close"), wxDefaultPosition, wxDefaultSize, 0);
	bSizer13->Add(m_button12, 0, wxALL, 5);
